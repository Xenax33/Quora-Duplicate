...
<body>
    ...
    <main>
        <div class="container d-flex p-4">
            ...
            <div class="col-md-7">
                <div class="card p-2 mb-2" onclick="showques()">
                    <div class="d-flex flex-column">
                        <div class="m-1">
                            ...
                            <?php echo "<img id='qcardavatar' name='qcardavatar' src='$DP_name'>" ?> <span
                                class="text-muted">
                                <?php echo $cname, "<br>"; ?>
                            </span>
                        ...
                        <span class="d-block font-weight-bold m-1 text-muted" id="quesHeading">What is your rant
                            question
                            ?</span>
                    </div>
                </div>
                ...
                <div class="card mb-2" id="qid">
                    <div class="d-flex flex-column">
                        ...
                        <div class="px-2 pb-2">
                            <span class="postdesc">
                                Kim Tae-hyung, known professionally as V, is a South Korean singer and a member of the
                                boy band BTS.
                                Since his debut with the band in 2013, V has performed three solo songs under their
                                name—"Stigma" in 2016, "Singularity" in 2018, and "Inner Child" in 2020—all of which
                                charted on South Korea's Gaon Digital Chart.
                            </span>
                        </div>
                ...
                <div class="card mb-2" id="qid">
                    <div class="d-flex flex-column">
                        <div class="d-flex m-1 p-2 justify-content-between">
                            ...
                            <form method="post" action="question.php"> <button id="qid"
                                    class="answerbtn">answer</button> </form>
                        </div>
                        <div class="px-2 pb-2">
                            <span class="postdesc">
                                Lee Jong-suk is a South Korean actor and model. He debuted in 2005 as a runway model,
                                becoming the youngest male model ever to participate in Seoul Fashion Week.
                            ...
                            echo
                                "<div class='card mb-2' id='$qid-container'>
                                        <div class='d-flex flex-column'>
                                            <div class='d-flex m-1 p-2 justify-content-between'>
                                                <div class='d-flex'>
                                                <img id='$qid-Avatar' name='$qid-Avatar' class='postimg' src='$profile'>
                                                    <div class='mx-2 d-flex flex-column'>
                                                        <span class='font-weight-bold postname h-50'>$custName</span>  
                                                        <span class='text-muted postdate  h-50'>posted-on $Asked_date</span>  
                                                    </div>
                                                </div>
                                                <form method='post' action='questions.php?id=$qid'> <button id='$qid' class='answerbtn p-2 px-4 rounded btn btn-primary'>Answer</button> </form>
                                            </div>
                                            <div class='px-2 pb-2'>
                                                <span class='postdesc'>
                                                    $Ques_desc
                            ...
                            echo
                                "<div class='card mb-2' id='$qid-container'>
                                            <div class='d-flex flex-column'>
                                                <div class='d-flex m-1 p-2 justify-content-between'>
                                                    <div class='d-flex'>
                                                        <img id='$qid-Avatar' name='$qid-Avatar' class='postimg' src='$  '>
                                                        <div class='mx-2 d-flex flex-column'>
                                                            <span class='font-weight-bold postname h-50'>$custName</span>  
                                                            <span class='text-muted postdate  h-50'>posted-on $Asked_date</span>  
                                                        </div>
            ...
            <div class="col-md-3">
                <!-- View Your Question Button -->
                <form action="viewQuestion.php" method="post">
                    <button type="submit" class="btn btn-primary btn-block mb-2">View Your Question</button>
                </form>

                <!-- Update Your Questions Button -->
                <form action="updateQuestion.php" method="post">
                    <button type="submit" class="btn btn-success btn-block mb-2">Update Your Questions</button>
                </form>

                <!-- Delete Your Questions Button -->
                <form action="deleteQuestion.php" method="post">
                    <button type="submit" class="btn btn-danger btn-block mb-2">Delete Your Questions</button>
                </form>
                <!-- View Your Anwsers -->
                <form action="ViewAnwsers.php" method="post">
                    <button type="submit" class="btn btn-secondary btn-block mb-2">View Your Anwsers</button>
                </form>
                <!-- Delete Your Anwsers -->
                <form action="DeleteAnwsers.php" method="post">
                    <button type="submit" class="btn btn-dark btn-block mb-2">Delete Your Anwsers</button>
                </form>
                 <!-- Update Your Anwser Button -->
                 <form action="updateAnswser.php" method="post">
                    <button type="submit" class="btn btn-warning btn-block mb-2">Update Your Answers</button>
                </form>
            </div>
