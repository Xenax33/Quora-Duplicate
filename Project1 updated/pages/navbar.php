...
<head>
    ...
    <body>
        ...
        <div class="navbar d-flex justify-content-center bg-white">
            ...
            <div class="navavatar">
               <?php echo "<img class='avatar' src='../assests/images/image.jpeg'  onclick='showProfile()'>"; ?> 
            </div>
                ...
                <div class="qcardcontainer">
                    <div class="qcard" id="qcard">
                        ...
                        <div class="qcardbody">
                            ...
                            <?php echo "<img src='../assests/images/image.jpeg' id='qcardavatar' name='qcardavatar' onclick='showProfile()'>"; ?> 
                    ...
                    <div class="qcard" id="catcard">
                        ...
                        <div class="qcardbody">
                            <div class="qcardinfo d-flex">
                                ...
                                <span><?php $cname ?></span>
                                <span><?php "../assests/images/image.jpeg" ?></span>
                            </div>
                            <div class="qcardques d-flex flex-column">
                                <span class="py-2">Choose the Tags of your question for better and quicker answers</span>
