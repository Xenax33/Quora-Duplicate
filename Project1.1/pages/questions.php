...
<?php
    ...
    $ansQuery = "SELECT * FROM anwsers WHERE questionsId = '$qid'";
        ...
        <main class="container d-flex p-4">
            ...
            <div class="d-flex flex-column w-100" >
                ...
                <div class="jumbotron w-100">
                    ...
                    <p class="lead"><?php echo $asker['Username']; ?></p>
                    <hr class="my-4">
                    <p style="font-size: larger;"><?php echo $question['body']; ?>?</p>
                    <small class="text-muted">posted on <?php echo $question['questioncreatedAt']; ?></small><br>
                    <small class="text-muted">Tags: <?php echo $question['tags']; ?></small>
                </div>
