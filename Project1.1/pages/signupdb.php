...
if (isset($_POST["signup-submit"])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["profilePic"]["tmp_name"], $targetFile)) {
            ...
            $sql = 'INSERT INTO userprofile (Username, email, password, Bio, Active, ProfilePic) VALUES("' . $uname . '","' . $newemail . '","' . $hashedpwd . '","' . $Bio . '", 1, "' . $targetFile . '")';
            mysqli_query($conn, $sql);

            // Display success message in an inline popup using JavaScript
            echo '<script>
